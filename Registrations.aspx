...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="form-control">
            ...
            <asp:ListItem Value="Buldhana">Buldhana</asp:ListItem>
            <asp:ListItem Value="Chandrapur">Chandrapur</asp:ListItem>
            <asp:ListItem Value="Dhule">Dhule</asp:ListItem>
            <asp:ListItem Value="Gadchiroli">Gadchiroli</asp:ListItem>
            <asp:ListItem Value="Gondia">Gondia</asp:ListItem>
            <asp:ListItem Value="Hingoli">Hingoli</asp:ListItem>
            ...
            <asp:ListItem Value="Mumbai City">Mumbai City</asp:ListItem>
            <asp:ListItem Value="Mumbai Suburban">Mumbai Suburban</asp:ListItem>
            <asp:ListItem Value="Nagpur">Nagpur</asp:ListItem>
            <asp:ListItem Value="Nanded">Nanded</asp:ListItem>
            <asp:ListItem Value="Nandurbar">Nandurbar</asp:ListItem>
            <asp:ListItem Value="Nashik">Nashik</asp:ListItem>
            ...
            <asp:ListItem Value="Pune">Pune</asp:ListItem>
            <asp:ListItem Value="Raigad">Raigad</asp:ListItem>
            <asp:ListItem Value="Ratnagiri">Ratnagiri</asp:ListItem>
            <asp:ListItem Value="Sangli">Sangli</asp:ListItem>
            <asp:ListItem Value="Satara">Satara</asp:ListItem>
            <asp:ListItem Value="Sindhudurg">Sindhudurg</asp:ListItem>
            <asp:ListItem Value="Solapur">Solapur</asp:ListItem>
            <asp:ListItem Value="Thane">Thane</asp:ListItem>
            <asp:ListItem Value="Wardha">Wardha</asp:ListItem>
            <asp:ListItem Value="Washim">Washim</asp:ListItem>
    ...
    <div class="form-group">
        ...
        <asp:DropDownList ID="ddlCity" runat="server" CssClass="form-control">
            ...
            <asp:ListItem Value="Nagpur">Nagpur</asp:ListItem>
            <asp:ListItem Value="Thane">Thane</asp:ListItem>
            <asp:ListItem Value="Pimpri-Chinchwad">Pimpri-Chinchwad</asp:ListItem>
            <asp:ListItem Value="Nashik">Nashik</asp:ListItem>
            <asp:ListItem Value="Kalyan-Dombivli">Kalyan-Dombivli</asp:ListItem>
            ...
            <asp:ListItem Value="Jalna">Jalna</asp:ListItem>
            <asp:ListItem Value="Ambarnath">Ambarnath</asp:ListItem>
            <asp:ListItem Value="Bhusawal">Bhusawal</asp:ListItem>
            <asp:ListItem Value="Panvel">Panvel</asp:ListItem>
            <asp:ListItem Value="Badlapur">Badlapur</asp:ListItem>
            <asp:ListItem Value="Beed">Beed</asp:ListItem>
            <asp:ListItem Value="Gondia">Gondia</asp:ListItem>
            <asp:ListItem Value="Satara">Satara</asp:ListItem>
            <asp:ListItem Value="Barshi">Barshi</asp:ListItem>
            <asp:ListItem Value="Yavatmal">Yavatmal</asp:ListItem>
            <asp:ListItem Value="Achalpur">Achalpur</asp:ListItem>
            <asp:ListItem Value="Osmanabad">Osmanabad</asp:ListItem>
            <asp:ListItem Value="Nandurbar">Nandurbar</asp:ListItem>
            <asp:ListItem Value="Wardha">Wardha</asp:ListItem>
            <asp:ListItem Value="Udgir">Udgir</asp:ListItem>
            <asp:ListItem Value="Hingoli">Hingoli</asp:ListItem>
            <asp:ListItem Value="Palghar">Palghar</asp:ListItem>
            <asp:ListItem Value="Malkapur">Malkapur</asp:ListItem>
            <asp:ListItem Value="Washim">Washim</asp:ListItem>
            <asp:ListItem Value="Jaysingpur">Jaysingpur</asp:ListItem>
            <asp:ListItem Value="Sillod">Sillod</asp:ListItem>
            <asp:ListItem Value="Mhaswad">Mhaswad</asp:ListItem>
            <asp:ListItem Value="Phaltan">Phaltan</asp:ListItem>
            <asp:ListItem Value="Pandharpur">Pandharpur</asp:ListItem>
            <asp:ListItem Value="Shrirampur">Shrirampur</asp:ListItem>
            <asp:ListItem Value="Parli">Parli</asp:ListItem>
            <asp:ListItem Value="Trimbakeshwar">Trimbakeshwar</asp:ListItem>
            <asp:ListItem Value="Mahabaleshwar">Mahabaleshwar</asp:ListItem>
            <asp:ListItem Value="Lonavla">Lonavla</asp:ListItem>
            <asp:ListItem Value="Talegaon">Talegaon</asp:ListItem>
            ...
            <asp:ListItem Value="Khed">Khed</asp:ListItem>
            <asp:ListItem Value="Matheran">Matheran</asp:ListItem>
            <asp:ListItem Value="Chiplun">Chiplun</asp:ListItem>
            <asp:ListItem Value="Ratnagiri">Ratnagiri</asp:ListItem>
            <asp:ListItem Value="Lanja">Lanja</asp:ListItem>
            <asp:ListItem Value="Rajapur">Rajapur</asp:ListItem>
            <asp:ListItem Value="Sangameshwar">Sangameshwar</asp:ListItem>
            <asp:ListItem Value="Sawantwadi">Sawantwadi</asp:ListItem>
            <asp:ListItem Value="Oros">Oros</asp:ListItem>
            <asp:ListItem Value="Vengurla">Vengurla</asp:ListItem>
            <asp:ListItem Value="Kankavli">Kankavli</asp:ListItem>
            <asp:ListItem Value="Malvan">Malvan</asp:ListItem>
            <asp:ListItem Value="Devgad">Devgad</asp:ListItem>
            <asp:ListItem Value="Vaibhavwadi">Vaibhavwadi</asp:ListItem>
            <asp:ListItem Value="Kudal">Kudal</asp:ListItem>
            <asp:ListItem Value="Sindhudurg">Sindhudurg</asp:ListItem>
            <asp:ListItem Value="Akkalkot">Akkalkot</asp:ListItem>
            <asp:ListItem Value="Jat">Jat</asp:ListItem>
            <asp:ListItem Value="Atpadi">Atpadi</asp:ListItem>
            <asp:ListItem Value="Tasgaon">Tasgaon</asp:ListItem>
            <asp:ListItem Value="Kavathemahankal">Kavathemahankal</asp:ListItem>
            <asp:ListItem Value="Jaisingpur">Jaisingpur</asp:ListItem>
            <asp:ListItem Value="Hatkanangale">Hatkanangale</asp:ListItem>
            <asp:ListItem Value="Shirol">Shirol</asp:ListItem>
            <asp:ListItem Value="Panhala">Panhala</asp:ListItem>
            <asp:ListItem Value="Kagal">Kagal</asp:ListItem>
            <asp:ListItem Value="Gadhinglaj">Gadhinglaj</asp:ListItem>
            <asp:ListItem Value="Ajra">Ajra</asp:ListItem>
            <asp:ListItem Value="Chandgad">Chandgad</asp:ListItem>
            <asp:ListItem Value="Radhanagari">Radhanagari</asp:ListItem>
            <asp:ListItem Value="Shahuwadi">Shahuwadi</asp:ListItem>
            <asp:ListItem Value="Karveer">Karveer</asp:ListItem>
            <asp:ListItem Value="Bavda">Bavda</asp:ListItem>
            <asp:ListItem Value="Bhudargad">Bhudargad</asp:ListItem>
            <asp:ListItem Value="Other">Other</asp:ListItem>
        </asp:DropDownList>
    </div>
</div>
